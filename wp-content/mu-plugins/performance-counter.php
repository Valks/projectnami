...
class KUSANAGI_Performance_viewer {
    ...
    public function enqueue() {
		wp_enqueue_style( 'kusanagi-performance', '/wp-content/mu-plugins/performance/css/performance-admin-bar.css', array(), $WP_KUSANAGI->version );
	}
...
new KUSANAGI_Performance_viewer;